...
public class NewBoardResponse {
    ...
    public String toString() {
        ...
        sb.append(NewBoardResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NewBoardResponse) == false) {
            return false;
        }
        NewBoardResponse rhs = ((NewBoardResponse) other);
