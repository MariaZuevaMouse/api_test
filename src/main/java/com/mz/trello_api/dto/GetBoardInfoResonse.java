...
public class GetBoardInfoResonse {
    ...
    public String toString() {
        ...
        sb.append(GetBoardInfoResonse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetBoardInfoResonse) == false) {
            return false;
        }
        GetBoardInfoResonse rhs = ((GetBoardInfoResonse) other);
