...
public class ModifyBoardResponse {
    ...
    @Expose
    private LabelNames__2 labelNames;
    ...
    public LabelNames__2 getLabelNames() {
        return labelNames;
    }

    public void setLabelNames(LabelNames__2 labelNames) {
    ...
    public String toString() {
        ...
        sb.append(ModifyBoardResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ModifyBoardResponse) == false) {
            return false;
        }
        ModifyBoardResponse rhs = ((ModifyBoardResponse) other);
