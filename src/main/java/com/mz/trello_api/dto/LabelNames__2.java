...
public class LabelNames__2 {
    ...
    public String toString() {
        ...
        sb.append(LabelNames__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("green");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LabelNames__2) == false) {
            return false;
        }
        LabelNames__2 rhs = ((LabelNames__2) other);
